...
var h = {
    ...
    App: {
        init: function(t) {
            ...
            try {
                "lauchOpts" in t && (f.Data.lanchInfo = t.lauchOpts, f.Data.lanchInfo.landing = 1);
            } catch (t) {}
        }
    },
    Page: {
        ...
        multiStat: function(t, n) {
            if (1 == n) f.Page.stat(t); else {
                var e = getCurrentPages()[getCurrentPages().length - 1];
                e.onShow && function() {
                    var n = e.onShow;
                    e.onShow = function() {
                        f.Page.stat(t), n.call(this, arguments);
                    };
                }();
            }
        },
        stat: function(t) {
            if ("" != h.app_id) {
                var n = [], e = p();
                if (t && (e.r2 = t), t = [ c(), e, u() ], f.Data.lanchInfo) {
                    t.push({
                        ht: f.Data.lanchInfo.scene,
                        rdm: "/",
                        rurl: f.Data.lanchInfo.path
                    }), f.Data.lanchInfo.query && f.Data.lanchInfo.query._mta_ref_id && t.push({
                        rarg: f.Data.lanchInfo.query._mta_ref_id
                    });
                    try {
                        1 == f.Data.lanchInfo.landing && (e.ext += ";lp=1", f.Data.lanchInfo.landing = 0);
                    } catch (t) {}
                }
                t.push({
                    rand: +new Date()
                }), e = 0;
                for (var a = t.length; e < a; e++) for (var r in t[e]) t[e].hasOwnProperty(r) && n.push(r + "=" + (void 0 === t[e][r] ? "" : t[e][r]));
                wx.request({
