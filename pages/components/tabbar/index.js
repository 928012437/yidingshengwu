  ...
  methods: {
    ...
    goWeapp: function(){
      ...
      if (type == 0) {
        ...
        let redUrls = ['/lionfish_comshop/moduleA/solitaire/index', '/lionfish_comshop/moduleA/video/index', '/lionfish_comshop/moduleA/menu/index', '/lionfish_comshop/moduleA/pin/index'];
        if (tabUrls.indexOf(url) != -1) {
          wx.switchTab({ url })
        } else if (redUrls.indexOf(url) != -1) {
          if(url == '/lionfish_comshop/moduleA/solitaire/index'&&this.data.needAut) {
